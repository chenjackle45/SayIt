...
更新：2026-09-11（v0.13.1 已發佈：#30 診斷版＋一鍵回報；同日另有 v0.12.1、v0.13.0）
...
| #30 Windows 自訂觸發鍵、右 Alt／右 Ctrl | 兩次誠實進度留言 | **v0.13.1 已發佈（2026-09-11 公開）**：監聽順序修正＋診斷日誌＋一鍵回報；焦點問題根因待實機回報 | 已回串（2026-09-11）；同事 LINE 實測；收到回報後開根因卡；右 Alt＋右 Ctrl 等根因後一起 |
