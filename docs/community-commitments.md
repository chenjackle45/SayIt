...
更新：2026-09-11（v0.13.0 發版中：設定頁兩卡＋#71、#74 廣東話；ElevenLabs 改排 v0.14）
...
| #74 廣東話選項 | 「排在修完 Windows 貼上之後」 | 已實作（f2eab44，2026-09-11；Groq `yue` 已驗、與 ElevenLabs 脫鉤），等 v0.13 發版 | 發版後回串：提醒用內建整理模式與預設 whisper-large-v3 |
...
| #71 模型清單標「需付費」 | 「之後會標更清楚」 | 已實作（243ee6b，2026-09-11；三態 freeTier 徽章），等 v0.13 發版 | 發版後回串 |
