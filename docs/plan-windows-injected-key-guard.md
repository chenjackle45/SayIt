...
> 建立：2026-09-11 · 狀態：codex 計劃閘一輪（1 HIGH、5 MED、1 LOW；HIGH 由使用者拍板乙案、其餘全收）＋實作閘一輪（0 HIGH、1 MED、1 LOW，全收）→ **已交付 v0.12.1（2026-09-11 公開；ac2dbf1）**，Windows 實機驗收 1～7、9 等回報者 · 排程：v0.12.1（插隊在 v0.13 之前）
